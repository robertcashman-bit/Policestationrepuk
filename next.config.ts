...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      // Lowercase → PascalCase redirects for key pages
      ...
      { source: "/premium", destination: "/Premium", permanent: true },
      { source: "/join", destination: "/Join", permanent: true },
      { source: "/whatsapp", destination: "/WhatsApp", permanent: true },
      { source: "/pace", destination: "/PACE", permanent: true },
      { source: "/ico", destination: "/ICO", permanent: true },
      { source: "/blog", destination: "/Blog", permanent: true },
      { source: "/accessibility", destination: "/Accessibility", permanent: true },
      { source: "/complaints", destination: "/Complaints", permanent: true },
      { source: "/dataprotection", destination: "/DataProtection", permanent: true },
      { source: "/formslibrary", destination: "/FormsLibrary", permanent: true },
      ...
      { source: "/howtobecome", destination: "/HowToBecome", permanent: true },
      { source: "/getwork", destination: "/GetWork", permanent: true },
      { source: "/gofeatured", destination: "/GoFeatured", permanent: true },
      { source: "/escapefeecalculator", destination: "/EscapeFeeCalculator", permanent: true },
      { source: "/policestationrates", destination: "/PoliceStationRates", permanent: true },
      { source: "/policestationreppay", destination: "/PoliceStationRepPay", permanent: true },
      { source: "/policestationrepjobsuk", destination: "/PoliceStationRepJobsUK", permanent: true },
      { source: "/stationsdirectory", destination: "/StationsDirectory", permanent: true },
      { source: "/whatdoesrepdo", destination: "/WhatDoesRepDo", permanent: true },
      { source: "/dutysolicitorvsrep", destination: "/DutySolicitorVsRep", permanent: true },
      { source: "/beginnersguide", destination: "/BeginnersGuide", permanent: true },
      { source: "/gettingstarted", destination: "/GettingStarted", permanent: true },
      { source: "/resources", destination: "/Resources", permanent: true },
      { source: "/legalupdates", destination: "/LegalUpdates", permanent: true },
      { source: "/policestationrepsbycounty", destination: "/PoliceStationRepsByCounty", permanent: true },
      { source: "/solicitorpolicestationcoveruk", destination: "/SolicitorPoliceStationCoverUK", permanent: true },
      { source: "/buildportfolioguide", destination: "/BuildPortfolioGuide", permanent: true },
      { source: "/criminallawcareerguide", destination: "/CriminalLawCareerGuide", permanent: true },
      { source: "/prepareforcit", destination: "/PrepareForCIT", permanent: true },
      { source: "/aboutfounder", destination: "/AboutFounder", permanent: true },
      { source: "/kentpolicestationreps", destination: "/KentPoliceStationReps", permanent: true },
      { source: "/repfaqmaster", destination: "/RepFAQMaster", permanent: true },
      { source: "/subscribe", destination: "/Subscribe", permanent: true },
      ...
      { source: "/Account", destination: "/register", permanent: false },
      { source: "/Profile", destination: "/register", permanent: false },
