...
export const COMMON_OFFENCES: OffenceGuideEntry[] = [
  ...
  },
  {
    ...
    legislationUrl: "https://www.cps.gov.uk/prosecution-guidance/offences-against-person-incorporating-charging-standard",
    triable: "Indictable only",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/kidnap-false-imprisonment/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2025. Offence range: community order – 16 years’ custody.",
    actusReus: [
      "Kidnap: take or carry away a person by force or fraud without their consent and without lawful excuse.",
      "False imprisonment: unlawfully and intentionally or recklessly restrain a person’s freedom of movement from a particular place.",
    ],
    mensRea: [
      "Intention to take/carry away (kidnap) or intention/recklessness as to the restraint (false imprisonment).",
    ],
    keyCases: [],
    commonDefences: ["Consent", "Lawful authority / citizen’s arrest power", "Deny the restraint or taking", "Identification"],
    stationNotes: "Common-law offences — use the CPS Offences Against the Person charging standard alongside the SC guideline. Check duration, use of force/weapons, vulnerability, and whether a sexual or robbery ulterior intent is alleged.",
  },
  {
    id: "unlawful-act-manslaughter",
    title: "Unlawful act manslaughter",
    statute: "Common law (manslaughter)",
    legislationUrl: "https://www.cps.gov.uk/prosecution-guidance/homicide-murder-manslaughter-infanticide-and-causing-or-allowing-death-or",
    triable: "Indictable only",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/unlawful-act-manslaughter/",
    sentencingNote: "Sentencing Council guideline effective 1 November 2018. Offence range: 1 – 24 years’ custody (check current guideline page).",
    actusReus: [
      "Commit an unlawful act that is dangerous in the sense that a sober and reasonable person would recognise the risk of some harm, and that act causes death.",
    ],
    mensRea: [
      "Mens rea for the base unlawful act; no need to foresee death.",
    ],
    keyCases: [],
    commonDefences: ["No unlawful act", "Act not dangerous", "Break in causation", "Self-defence as to the base assault"],
    stationNotes: "Often arises from assaults or one-punch cases. Causation and the dangerousness of the act are key. Cross-check CPS homicide charging standard.",
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 1 November 2018. Offence range: 1 – 18 years’ custody (check current guideline page).",
    actusReus: [
      "Breach of a duty of care owed to the deceased by a grossly negligent act or omission that causes death.",
    ],
    mensRea: [
      "Gross negligence — a risk of death that was obvious and a breach so bad it deserves criminal sanction (objective).",
    ],
    keyCases: [],
    commonDefences: ["No duty of care", "Breach not gross", "Death not caused by the breach", "Reasonable care taken"],
    stationNotes: "Medical, workplace, and caregiving contexts are common. Obtain expert reports early. Cross-check CPS homicide guidance.",
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/manslaughter-by-reason-of-loss-of-control/",
    sentencingNote: "Sentencing Council guideline effective 01 November 2018. Offence range: 3 – 20 years’ custody.",
    actusReus: [
      "Conduct prohibited by Coroners and Justice Act 2009, ss.54–55 (partial defence); manslaughter at common law — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
    ...
    keyCases: [],
    commonDefences: ["Deny actus reus", "Deny mens rea", "Statutory defence if available", "Identification / alibi"],
    stationNotes: "Confirm the exact charge wording, linked offences, and disclosure. Follow the linked Sentencing Council guideline for category factors.",
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/manslaughter-by-reason-of-diminished-responsibility/",
    sentencingNote: "Sentencing Council guideline effective 01 November 2018. Offence range: 3 – 40 years’ custody.",
    actusReus: [
      "Conduct prohibited by Homicide Act 1957, s.2; manslaughter at common law — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 1 July 2021. Offence range: 3 – 40 years’ custody.",
    actusReus: [
      "Do an act that is more than merely preparatory to the commission of murder (Criminal Attempts Act 1981, s.1).",
    ],
    mensRea: [
      "Intention to kill (nothing less — intent to cause GBH is insufficient for attempted murder).",
    ],
    keyCases: [],
    commonDefences: ["No intent to kill", "Act merely preparatory", "Self-defence / defence of another", "Identification"],
    stationNotes: "Intent to kill is the critical interview issue. Preserve weapons, medical evidence, and any planning messages. Distinguish from s.18 GBH with intent.",
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 1 February 2016. Offence range: £180,000 fine – £20 million fine.",
    actusReus: [
      "Conduct prohibited by Corporate Manslaughter and Corporate Homicide Act 2007, s.1 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 1 April 2016. Offence range: 1 year’s custody – 16 years’ custody.",
    actusReus: [
      "Conduct prohibited by Theft Act 1968, s.8 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/robbery-professionally-planned-commercial/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2016. Offence range: 18 months’ – 20 years’ custody.",
    actusReus: [
      "Conduct prohibited by Theft Act 1968, s.8 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
  ...
  },
  {
    ...
    legislationUrl: "https://www.legislation.gov.uk/ukpga/1971/48/section/1",
    triable: "Summary only",
    maxPenalty: "Level 4 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/criminal-damage-other-than-by-fire-value-not-exceeding-5-000-racially-or-religiously-aggravated-criminal-damage/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2019. Offence range: Discharge – 3 months’ custody *.",
    actusReus: [
      "Conduct prohibited by Criminal Damage Act 1971, s.1(1) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "4 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/bladed-articles-and-offensive-weapons-threats/",
    sentencingNote: "Sentencing Council guideline effective 1 June 2018. Offence range: 6 months’ custody – 3 years’ custody This guideline applies only to offenders aged 18 or older.",
    actusReus: [
      "Conduct prohibited by Criminal Justice Act 1988, s.139AA; Prevention of Crime Act 1953, s.1A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/firearms-possession-with-intent-to-endanger-life/",
    sentencingNote: "Sentencing Council guideline effective 01 January 2021. Offence range: 4 – 22 years’ custody.",
    actusReus: [
      "Conduct prohibited by Firearms Act 1968, s.16 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/firearms-possession-with-intent-other-offences/",
    sentencingNote: "Sentencing Council guideline effective 01 January 2021. Offence range: High level community order – 16 years’ custody.",
    actusReus: [
      "Conduct prohibited by Firearms Act 1968, ss.17(2), 18 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "5 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/firearms-possession-by-person-prohibited/",
    sentencingNote: "Sentencing Council guideline effective 01 January 2021. Offence range: Discharge – 4 years’ custody.",
    actusReus: [
      "Conduct prohibited by Firearms Act 1968, s.21 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/firearms-transfer-and-manufacture/",
    sentencingNote: "Sentencing Council guideline effective 01 January 2021. Offence range: 3 – 28 years’ custody.",
    actusReus: [
      "Conduct prohibited by Firearms Act 1968 (transfer/manufacture provisions; check charged section) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "14 years (7 years for offences committed before 22 February 2024) unless committed in Great Britain in connection with a prohibition or res",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/firearms-importation/",
    sentencingNote: "Sentencing Council guideline effective 01 January 2022. Offence range: Fine – 28 years’ custody.",
    actusReus: [
      "Conduct prohibited by Customs and Excise Management Act 1979 / Firearms Act 1968 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "14 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/aggravated-vehicle-taking-death-caused/",
    sentencingNote: "Sentencing Council guideline effective 01 April 2025. Offence range: 1 – 12 years’ custody.",
    actusReus: [
      "Conduct prohibited by Theft Act 1968, s.12A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "life imprisonment for offences committed after 28 June 2022; otherwise 14 years' custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-death-by-dangerous-driving/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2023. Offence range: 2 – 18 years’ custody.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.1 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "life imprisonment for offences committed after 28 June 2022; otherwise 14 years' custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-death-by-careless-driving-whilst-under-the-influence-of-drink-or-drugs-causing-death-by-careless-driving-when-under-the-influence-of-drink-or-drugs-or-having-failed-either-to-provide-a-specimen-for-analysis-or-to-permit-analysis-of-/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2023. Offence range: 26 weeks – 18 years’ custody.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.3A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "2 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-death-by-driving-unlicensed-or-uninsured-drivers/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2023. Offence range: Community order – 2 years’ custody.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.3ZB — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-death-by-driving-disqualified-drivers/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2023. Offence range: Community order – 7 years’ custody.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.3ZC — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "5 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-serious-injury-by-dangerous-driving/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2023. Offence range: 26 weeks – 5 years’ custody.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.1A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "4 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-serious-injury-by-driving-disqualified-drivers/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2023. Offence range: Community order – 4 years’ custody.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.3ZD — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 4 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/being-in-charge-of-a-motor-vehicle-with-a-specified-drug-above-the-specified-limit/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2023. Offence range: Band B fine – 12 weeks’ custody.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.5A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
  ...
  },
  {
    ...
    legislationUrl: "https://www.legislation.gov.uk/ukpga/1988/52/section/4",
    triable: "Summary only",
    maxPenalty: "Level 4 fine and/ or 3 months",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/unfit-through-drink-or-drugs-in-charge-revised-2017/",
    sentencingNote: "Sentencing Council guideline effective 24 April 2017. Offence range: Band B fine - 12 weeks’ custody.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.4(2) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fail-to-co-operate-with-preliminary-roadside-breath-test/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band B fine Must endorse and impose 4 points Starting point:  Band B fine Fines Starting point Range.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.6(6) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 4 fine and/ or 3 months",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fail-to-provide-specimen-for-analysis-in-charge-revised-2017/",
    sentencingNote: "Sentencing Council guideline effective 24 April 2017. Offence range: Band B fine - 6 weeks’ custody.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.7(6) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "5 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/possession-of-articles-for-use-in-frauds-making-or-supplying-articles-for-use-in-frauds/",
    sentencingNote: "Sentencing Council guideline effective 1 October 2014. Offence range: Band A fine – 3 years’ custody Making or supplying articles for use in frauds Fraud Act 2006 (section 7) Triable either.",
    actusReus: [
      "Conduct prohibited by Fraud Act 2006, ss.6–7 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 1 October 2014. Offence range: Discharge – 6 years 6 months’ custody False representations for obtaining benefit etc ,  Social Security Administr.",
    actusReus: [
      "Conduct prohibited by Social Security Administration Act 1992 / Fraud Act 2006 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 1 October 2014. Offence range: Low level community order – 8 years’ custody Fraud , Fraud Act 2006 (section 1) Triable either way Maximum: 10 years’ c.",
    actusReus: [
      "Conduct prohibited by Fraud Act 2006 / Customs and Excise Management Act 1979 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 1 October 2014. Offence range: Discharge – 8 years’ custody.",
    actusReus: [
      "Conduct prohibited by Bribery Act 2010, ss.1–2 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "Maximum when tried summarily: Level 5 fine Maximum when tried on indictment: 2 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/vehicle-registration-fraud/",
    sentencingNote: "Sentencing Council guideline effective 01 April 2025. Offence range: Fine – 1 year six months’ custody.",
    actusReus: [
      "Conduct prohibited by Vehicle Excise and Registration Act 1994 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment (if penetration involved), otherwise 10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-a-person-to-engage-in-sexual-activity-without-consent/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 7 years’ custody (if no penetration involved)/19 years' custody (if penetration involved) Where.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, s.4 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/assault-of-a-child-under-13-by-penetration/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: 2 – 19 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, s.6 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment (if penetration involved), otherwise 14 years' custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-or-inciting-a-child-under-13-to-engage-in-sexual-activity/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: 1 – 17 years’ custody Where the offence involved penetration this is a Schedule 19 offence for the purposes of sections.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, s.8 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "14 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/sexual-activity-with-a-child-family-member-inciting-a-child-family-member-to-engage-in-sexual-activity/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 10 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.25–26 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "Life imprisonment (penetrative, offences on/after 28 June 2022); otherwise see guideline",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/arranging-or-facilitating-the-commission-of-a-child-sex-offence/",
    sentencingNote: "Sentencing Council guideline effective 31 May 2022.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, s.14 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/engaging-in-sexual-activity-in-the-presence-of-a-child-causing-a-child-to-watch-a-sexual-act/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 6 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.11–12 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "5 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/abuse-of-position-of-trust-sexual-activity-with-a-child-abuse-of-position-of-trust-causing-or-inciting-a-child-to-engage-in-sexual-activity/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 2 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.16–19 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "5 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/abuse-of-position-of-trust-sexual-activity-in-the-presence-of-a-child-abuse-of-position-of-trust-causing-a-child-to-watch-a-sexual-act/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 2 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.18–19 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment (if penetration involved), otherwise 14 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/sexual-activity-with-a-person-with-a-mental-disorder-impeding-choice-causing-or-inciting-a-person-with-a-mental-disorder-impeding-choice-to-engage-in-sexual-activity/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 19 years’ custody Where the offence involved penetration these are Schedule 19 offences for the purpo.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.30–31 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "14 years’ custody (if penetration involved), otherwise 10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/care-workers-sexual-activity-with-a-person-with-a-mental-disorder-care-workers-causing-or-inciting-sexual-activity/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 10 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.38–41 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment (if penetration involved), otherwise 14 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/inducement-threat-or-deception-to-procure-sexual-activity-with-a-person-with-a-mental-disorder-causing-a-person-with-a-mental-disorder-to-engage-in-or-agree-to-engage-in-sexual-activity-by-inducement-threat-or-deception/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 10 years’ custody Where the offence involved penetration these are Schedule 19 offences for the purpo.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.34–37 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "2 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/sex-with-an-adult-relative-penetration-sex-with-an-adult-relative-consenting-to-penetration/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Fine – 2 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.64–65 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Unlimited fine and/or 6 months",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/sexual-activity-in-a-public-lavatory/",
    sentencingNote: "Sentencing Council guideline effective 24 April 2017. Offence range: Band A fine - High level community order.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, s.71 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/trespass-with-intent-to-commit-a-sexual-offence/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: 1 – 9 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, s.63 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment (if kidnapping or false imprisonment committed), otherwise 10 years' custody Applicability In accordance with section 120",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/committing-an-offence-with-intent-to-commit-a-sexual-offence/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, s.62 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Victim under 13 (penetrative), Life imprisonment Victim under 13 (non-penetrative), 14 years’ custody Victim aged 13–15, 14 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/paying-for-the-sexual-services-of-a-child/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Victim aged 16–17, Community order – 5 years’ custody This guideline should be used only where the victim is aged 16 or.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, s.47 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "7 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-or-inciting-prostitution-for-gain-controlling-prostitution-for-gain/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 6 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.52–53 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "14 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-or-inciting-sexual-exploitation-of-a-child-controlling-a-child-in-relation-to-sexual-exploitation-arranging-or-facilitating-sexual-exploitation-of-a-child/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Victim aged under 13: 1 - 13 years' custody Victim aged 13 - 15: 26 weeks' - 11 years' custody Victim aged 16 - 17: Com.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.48–50 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "7 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/keeping-a-brothel-used-for-prostitution/",
    sentencingNote: "Sentencing Council guideline effective 01 April 2014. Offence range: Community order – 6 years’ custody The terms “prostitute” and “prostitution” are used in this guideline in accordance w.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 1956, s.33A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "14 years’ custody for offences committed after 28 June 2022; otherwise 10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/causing-or-allowing-a-child-to-suffer-serious-physical-harm-causing-or-allowing-a-child-to-die/",
    sentencingNote: "Sentencing Council guideline effective 01 April 2023. Offence range: Community order – 12 years’ custody Causing or allowing a child to die Indictable only Maximum: life imprisonment for o.",
    actusReus: [
      "Conduct prohibited by Domestic Violence, Crime and Victims Act 2004, s.5 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment (if kidnapping or false imprisonment committed), otherwise 10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/committing-offence-with-intent-to-commit-a-human-trafficking-offence/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2021.",
    actusReus: [
      "Conduct prohibited by Modern Slavery Act 2015, s.4 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/breach-of-a-slavery-and-trafficking-prevention-order-breach-of-a-slavery-and-trafficking-risk-order/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2021.",
    actusReus: [
      "Conduct prohibited by Modern Slavery Act 2015 (STPO/STRO breach provisions) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "7 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/supplying-or-offering-to-supply-a-psychoactive-substance-possession-of-psychoactive-substance-with-intent-to-supply/",
    sentencingNote: "Sentencing Council guideline effective 01 April 2021. Offence range: Band B Fine – 6 years’ custody.",
    actusReus: [
      "Conduct prohibited by Psychoactive Substances Act 2016, ss.5, 7 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "7 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/importing-or-exporting-a-psychoactive-substance/",
    sentencingNote: "Sentencing Council guideline effective 01 April 2021. Offence range: Discharge – 6 years’ custody.",
    actusReus: [
      "Conduct prohibited by Psychoactive Substances Act 2016, s.8 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "14 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/proscribed-organisations-membership/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2022. Offence range: High level community order – 13 years’ custody.",
    actusReus: [
      "Conduct prohibited by Terrorism Act 2000, s.11 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "14 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/proscribed-organisations-support/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2022. Offence range: High level community order – 13 years’ custody.",
    actusReus: [
      "Conduct prohibited by Terrorism Act 2000, s.12 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 01 October 2022. Offence range: High level community order – 13 years’ custody.",
    actusReus: [
      "Conduct prohibited by Terrorism Act 2000, ss.15–18 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "15 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/collection-of-terrorist-information/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2022. Offence range: High level community order – 14 years’ custody.",
    actusReus: [
      "Conduct prohibited by Terrorism Act 2000, s.58 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "15 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/possession-for-terrorist-purposes/",
    sentencingNote: "Sentencing Council guideline effective 27 April 2018. Offence range: 1 – 14 years’ custody.",
    actusReus: [
      "Conduct prohibited by Terrorism Act 2000, s.57 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 01 October 2022. Offence range: 3 years’ custody – Life Imprisonment (minimum term 40 years).",
    actusReus: [
      "Conduct prohibited by Terrorism Act 2006, s.5 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "15 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/encouragement-of-terrorism-dissemination-of-terrorist-publications/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2022. Offence range: High level community order – 14 years’ custody.",
    actusReus: [
      "Conduct prohibited by Terrorism Act 2006, ss.1–2 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Indictable only",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/explosive-substances-terrorism-only/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2022. Offence range: 3 years’ custody – Life Imprisonment (minimum term 40 years).",
    actusReus: [
      "Conduct prohibited by Explosive Substances Act 1883 (terrorism context as per guideline) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/failure-to-disclose-information-about-acts-of-terrorism/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2022. Offence range: High level community order – 9 years' custody.",
    actusReus: [
      "Conduct prohibited by Terrorism Act 2000, s.38B — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "Maximum of 112 hours in any period of 7 days",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/breach-of-a-community-order/",
    sentencingNote: "Sentencing Council guideline effective 1 October 2018.",
    actusReus: [
      "Conduct prohibited by Sentencing Code (community order breach provisions) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "Maximum of 112 hours in any period of 7 days",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/breach-of-a-suspended-sentence-order/",
    sentencingNote: "Sentencing Council guideline effective 1 October 2018.",
    actusReus: [
      "Conduct prohibited by Sentencing Code (suspended sentence breach provisions) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "See Sentencing Council guideline (breach powers / supervision default order)",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/breach-of-post-sentence-supervision-breach-of-supervision-default-order/",
    sentencingNote: "Sentencing Council guideline effective 1 October 2018.",
    actusReus: [
      "Conduct prohibited by Offender Rehabilitation Act 2014 / Sentencing Code (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "14 years' custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/owner-or-person-in-charge-of-a-dog-dangerously-out-of-control-in-any-place-in-england-or-wales-whether-or-not-a-public-place-where-death-is-caused/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2016. Offence range: High level community order – 14 years’ custody.",
    actusReus: [
      "Conduct prohibited by Dangerous Dogs Act 1991, s.3 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "3 years' custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/owner-or-person-in-charge-of-a-dog-dangerously-out-of-control-in-any-place-in-england-or-wales-whether-or-not-a-public-place-where-an-assistance-dog-is-injured-or-killed/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2016. Offence range: Discharge – 2 years 6 months’ custody.",
    actusReus: [
      "Conduct prohibited by Dangerous Dogs Act 1991, s.3 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "6 months' custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/possession-of-a-prohibited-dog-breeding-selling-exchanging-or-advertising-a-prohibited-dog/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2016. Offence range: Discharge – 6 months’ custody.",
    actusReus: [
      "Conduct prohibited by Dangerous Dogs Act 1991, s.1 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "See guideline / charging decision",
    maxPenalty: "7 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/failing-to-protect-girl-from-risk-of-genital-mutilation/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2019. Offence range: Community order – 6 years’ custody.",
    actusReus: [
      "Conduct prohibited by Female Genital Mutilation Act 2003, s.3A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 4 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/drugs-class-a-failrefuse-to-provide-a-sample/",
    sentencingNote: "Sentencing Council guideline effective 24 April 2017. Offence range: Band A fine - High level community order.",
    actusReus: [
      "Conduct prohibited by Police and Criminal Evidence Act 1984 / Drugs Act provisions as charged — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 4 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/drugs-class-a-fail-to-attendremain-for-initial-assessment/",
    sentencingNote: "Sentencing Council guideline effective 24 April 2017. Offence range: Band A fine - High level community order.",
    actusReus: [
      "Conduct prohibited by Drugs Act 2005 (assessment provisions as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "6 months’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/individuals-sale-of-knives-etc-by-retailers-to-persons-under-18/",
    sentencingNote: "Sentencing Council guideline effective 01 April 2023. Offence range: Discharge – community order Use this guideline when the offender is an individual.",
    actusReus: [
      "Conduct prohibited by Criminal Justice Act 1988, s.141A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "2 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/breach-of-disqualification-from-acting-as-a-director/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2018. Offence range: Discharge – 1 year and 6 months’ custody.",
    actusReus: [
      "Conduct prohibited by Company Directors Disqualification Act 1986, s.13 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "6 months’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/breach-of-disqualification-from-keeping-an-animal/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2018. Offence range: Discharge – 26 weeks’ custody.",
    actusReus: [
      "Conduct prohibited by Animal Welfare Act 2006, s.34 / related breach provisions — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 01 June 2026. Offence range: Band A fine – 6 months’ custody.",
    actusReus: [
      "Conduct prohibited by Hunting Act 2004 / related provisions as charged — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine (s",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/alcohol-sale-offences-revised-2017/",
    sentencingNote: "Sentencing Council guideline effective 24 April 2017. Offence range: Conditional Discharge - Band C fine.",
    actusReus: [
      "Conduct prohibited by Licensing Act 2003 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/tv-licence-payment-evasion-revised-2017/",
    sentencingNote: "Sentencing Council guideline effective 24 April 2017. Offence range: Band A fine - Band B fine.",
    actusReus: [
      "Conduct prohibited by Communications Act 2003, s.363 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Excise penalty of Level 3",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/no-excise-licence/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band C excise penalty This offence is non-endorsable and does not attract penalty points.",
    actusReus: [
      "Conduct prohibited by Vehicle Excise and Registration Act 1994, s.29 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band B fine Starting point Driver: Band A fine When the offence is committed in the course of a business:.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.47 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 2 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/seat-belt-offences/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band A fine Starting point: Band A fine This offence is non-endorsable and does not attract penalty points.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.14 / regulations — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/keeping-a-vehicle-which-does-not-meet-insurance-requirements/",
    sentencingNote: "Sentencing Council guideline effective 13 July 2026. Offence range: Discharge to Band A fine   Starting point: Band  A  fine   This offence is non-endorsable and does.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.144A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/individuals-trade-mark-unauthorised-use-of-etc/",
    sentencingNote: "Sentencing Council guideline effective 01 October 2021. Offence range: Discharge – 7 years’ custody Use this guideline when the offender is an individual.",
    actusReus: [
      "Conduct prohibited by Trade Marks Act 1994, s.92 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "2 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/individuals-breach-of-duty-of-employer-towards-employees-and-non-employees-breach-of-duty-of-self-employed-to-others-breach-of-duty-of-employees-at-work-breach-of-health-and-safety-regulations-secondary-liability/",
    sentencingNote: "Sentencing Council guideline effective 01 February 2016. Offence range: Conditional discharge – 2 years’ custody.",
    actusReus: [
      "Conduct prohibited by Health and Safety at Work etc. Act 1974 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "when tried on indictment, unlimited fine and/or 2 years’ custody when tried summarily: unlimited fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/individuals-breach-of-food-safety-and-food-hygiene-regulations/",
    sentencingNote: "Sentencing Council guideline effective 01 February 2016. Offence range: Conditional discharge - 18 months' custody.",
    actusReus: [
      "Conduct prohibited by Food Safety Act 1990 / Food Hygiene Regulations (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "5 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/individuals-unauthorised-or-harmful-deposit-treatment-or-disposal-etc-of-waste-illegal-discharges-to-air-land-and-water/",
    sentencingNote: "Sentencing Council guideline effective 1 July 2014. Offence range: conditional discharge – 3 years’ custody Use this guideline when the offender is an individual.",
    actusReus: [
      "Conduct prohibited by Environmental Protection Act 1990 / related provisions (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "6 months' custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/owner-or-person-in-charge-of-a-dog-dangerously-out-of-control-in-any-place-in-england-or-wales-whether-or-not-a-public-place/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2016. Offence range: Discharge – 6 months’ custody.",
    actusReus: [
      "Conduct prohibited by Dangerous Dogs Act 1991, s.3 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/engaging-in-sexual-activity-in-the-presence-of-a-person-with-mental-disorder-impeding-choice-causing-a-person-with-mental-disorder-impeding-choice-to-watch-a-sexual-act/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 6 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.32–33 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "7 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/care-workers-sexual-activity-in-the-presence-of-a-person-with-a-mental-disorder-care-workers-causing-a-person-with-a-mental-disorder-to-watch-a-sexual-act/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 2 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.40–41 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "Life imprisonment",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fraudulent-evasion-of-a-prohibition-by-bringing-into-or-taking-out-of-the-uk-a-controlled-drug/",
    sentencingNote: "Sentencing Council guideline effective 01 April 2021. Offence range: Band A fine – 16 years’ custody Class B Maximum: 14 years’ custody and/ or unlimited fine Offence range: Discharge – 10.",
    actusReus: [
      "Conduct prohibited by Customs and Excise Management Act 1979, s.170 (controlled drugs context) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Unlimited fine and/or 6 months",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/failure-to-ensure-animal-welfare/",
    sentencingNote: "Sentencing Council guideline effective 01 July 2023. Offence range: Band A fine – 26 weeks’ custody.",
    actusReus: [
      "Conduct prohibited by Animal Welfare Act 2006, s.9 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Either way",
    maxPenalty: "10 years’ custody",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/engaging-in-sexual-activity-in-the-presence-procured-by-inducement-threat-or-deception-of-a-person-with-mental-disorder-causing-a-person-with-a-mental-disorder-to-watch-a-sexual-act-by-inducement-threat-or-deception/",
    sentencingNote: "Sentencing Council guideline effective 1 April 2014. Offence range: Community order – 6 years’ custody.",
    actusReus: [
      "Conduct prohibited by Sexual Offences Act 2003, ss.36–37 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 5 fine mechanically propelled vehicle",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fail-to-stop-when-required-by-police-constable/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band B fine This offence is non-endorsable and does not attract penalty points  Starting point:.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.163 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fail-to-comply-with-police-constable-directing-traffic/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band A fine Must endorse and impose 3 points Starting point:  Band A fine Fines Starting point Range.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.35 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Maximum Level 3 fine (s",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/school-non-attendance-revised-2017/",
    sentencingNote: "Sentencing Council guideline effective 24 April 2017. Offence range: Offence range Conditional discharge - Band C fine (s.",
    actusReus: [
      "Conduct prohibited by Education Act 1996, s.444 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    legislationUrl: "https://www.legislation.gov.uk/ukpga/1994/22/section/29",
    triable: "Summary only",
    maxPenalty: "Excise penalty of Level 4",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/using-an-untaxed-vehicle-with-a-sorn-on-a-public-road/",
    sentencingNote: "Sentencing Council guideline effective 13 July 2026. Offence range: Discharge to Band   C excise penalty   This offence  is non-endorsable and does not attract penalty poin.",
    actusReus: [
      "Conduct prohibited by Vehicle Excise and Registration Act 1994, s.29 / related provisions — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fail-to-comply-with-traffic-sign-endorsable/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band A fine Must endorse and impose 3 points Starting point:  Band A fine Fines  Starting point.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.36 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fail-to-comply-with-traffic-sign-non-endorsable/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band A fine This offence is non-endorsable and does not attract penalty points Starting point:  Band.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.36 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band A fine Starting point:  Band A fine Must endorse and impose 3 points Fines Starting point Range.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.22 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band B fine Starting point Driver: Band A fine When the offence is committed in the course of a business:.",
    actusReus: [
      "Conduct prohibited by Road Vehicle Lighting Regulations / Road Traffic Act 1988 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    legislationUrl: "https://www.legislation.gov.uk/ukpga/1988/52/section/41A",
    triable: "Summary only",
    maxPenalty: "Maximum for vehicles up to 3",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/tyres-defective/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band C fine Must endorse and impose 3 points (.",
    actusReus: [
      "Conduct prohibited by Road Vehicles (Construction and Use) Regulations / RTA 1988 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 4 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fail-to-produce-insurance-certificate/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band A fine This offence is non-endorsable and does not attract penalty points Starting point:  Band.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.165 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fail-to-produce-test-certificate/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band A fine This offence is non-endorsable and does not attract penalty points Starting point:  Band.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.165 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fail-to-notify-change-of-ownership-to-dvla/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band B fine Starting point Driver: Band A fine When the offence is committed in the course of a business:.",
    actusReus: [
      "Conduct prohibited by Vehicle Excise and Registration Act 1994 / regulations (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "For goods vehicles over 3",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/no-operators-licence/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band   C  fine   Starting point:  Driver: Band B fine  Owner-company: Band C fine.",
    actusReus: [
      "Conduct prohibited by Goods Vehicles (Licensing of Operators) Act 1995, s.2 — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/pelicanzebra-crossing-contravention/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band A fine Starting point:  Band A fine Must endorse and impose 3 points Fines Starting point Range.",
    actusReus: [
      "Conduct prohibited by Zebra, Pelican and Puffin Pedestrian Crossings Regulations / RTA 1988 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 2 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/fail-to-use-appropriate-child-car-seat/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.15 / regulations — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 4 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/stop-on-hard-shoulder-on-motorway/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band   A  fine This offence is non-endorsable  and does not attract penalty points.",
    actusReus: [
      "Conduct prohibited by Motorways Traffic (England and Wales) Regulations / RTA 1988 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 4 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/drive-in-reverse-or-wrong-way-on-motorway/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band   C  fine Must endorse and impose 3 points   Starting point: Band C fine &nb.",
    actusReus: [
      "Conduct prohibited by Motorways Traffic (England and Wales) Regulations / RTA 1988 (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "Level 3 fine",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/drive-a-vehicle-when-the-registration-mark-fails-to-conform-with-regulations/",
    sentencingNote: "Sentencing Council guideline effective 13 July 2026. Offence range: Discharge to Band A fine This offence is non-endorsable and does not attract penalty points Starting point:  Band.",
    actusReus: [
      "Conduct prohibited by Vehicle Excise and Registration Act 1994 / regulations (as charged) — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "for vehicles up to 3",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/condition-of-vehicleaccessories-equipment-involving-danger-of-injury/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band C fine Must impose 3 penalty points.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.40A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
    mensRea: [
      "Mental element as required by the statute (or common law) for the charged offence — check the specific section.",
  ...
  },
  {
    ...
    triable: "Summary only",
    maxPenalty: "for vehicles up to 3",
    sentencingGuidelineUrl: "https://www.sentencingcouncil.org.uk/guidelines/weight-position-or-distribution-of-load-or-manner-in-which-load-secured-involving-danger-of-injury/",
    sentencingNote: "Sentencing Council guideline effective 04 August 2008. Offence range: Discharge to Band B fine Must impose 3 penalty points.",
    actusReus: [
      "Conduct prohibited by Road Traffic Act 1988, s.40A — see the linked legislation for the full statutory wording.",
      "The prosecution must prove each element of the charged offence beyond reasonable doubt.",
    ],
