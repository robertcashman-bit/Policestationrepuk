    ...
    <>
      <section className="bg-[var(--navy)] py-12 sm:py-16">
        <div className="page-container !py-0">
          ...
          <p className="mt-4 max-w-2xl text-lg leading-relaxed text-slate-300">Everything you need to know about police interviews: the caution, your rights, what to expect, and how representation can help.</p>
        </div>
      </section>
