    ...
    <section className="section-pad bg-[var(--navy)]" aria-label="Custody Note promotion">
      <div className="page-container !py-0">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-6 inline-flex items-center gap-2 rounded-full border-2 border-[var(--gold)] bg-[var(--navy-light)] px-5 py-2 text-sm font-semibold text-[var(--gold)]">
