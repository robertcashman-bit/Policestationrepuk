...
export const WHATSAPP_AUDIENCE_PAGES = {
  reps: {
    ...
    headline:
      "Join the WhatsApp group as a fully accredited police station rep",
    intro:
    ...
    related: [
      ...
      { href: publicPath("/GetWork"), label: "Get Work guide" },
      { href: "/directory", label: "Browse the reps directory" },
    ],
  },
  solicitors: {
    path: WHATSAPP_PAGE_SOLICITORS,
    label: "Solicitors",
    ...
    related: [
      {
        href: publicPath("/PoliceStationCover"),
        label: "Police station cover for firms",
      },
  ...
  firms: {
    ...
    related: [
      {
        href: publicPath("/PoliceStationCover"),
        label: "Police station cover hub",
      },
