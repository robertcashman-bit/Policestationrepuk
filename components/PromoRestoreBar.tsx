        ...
        {!cnDismissed && (
          <>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex h-8 min-h-[2rem] max-w-[40%] shrink-0 items-center justify-center truncate rounded-full border border-white/40 bg-white/10 px-2.5 py-0.5 text-[10px] font-bold text-white no-underline transition-colors hover:border-[var(--gold)] hover:text-[var(--gold)] sm:h-9 sm:max-w-none sm:px-3 sm:text-[11px]"
            >
              {CUSTODYNOTE_MAC_DOWNLOAD_CTA}
            </a>
          </>
