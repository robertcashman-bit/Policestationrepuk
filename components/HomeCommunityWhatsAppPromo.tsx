      ...
      <div className="page-container !py-0">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-sm leading-relaxed text-emerald-100/85 sm:text-base">
            ...
            support. Free; members are verified before being added. Text{' '}
            <strong className="text-white">{WHATSAPP_JOIN_PHONE}</strong> or use the button — full steps are on the
            joining page.
          </p>
        </div>

        <article className="mx-auto mt-8 max-w-2xl rounded-[var(--radius-lg)] border border-white/10 bg-white/[0.06] p-5 shadow-lg backdrop-blur-sm sm:mt-10 sm:p-7">
          <h3 className="text-base font-bold text-white sm:text-lg">Get on the list</h3>
          <p className="mt-3 text-sm leading-relaxed text-emerald-50/95">
            Message <strong className="text-white">{WHATSAPP_JOIN_PHONE}</strong> with your name and whether you&apos;re
            a rep or a firm. We verify accreditation / firm details where needed, then send a WhatsApp invite.
          </p>
