    ...
    <>
      ...
      <div className="max-w-3xl space-y-10">
        ...
        <section>
          ...
          <div className="rounded-[var(--radius-lg)] border border-amber-200 bg-amber-50/50 p-5 dark:border-amber-900/30 dark:bg-amber-950/20">
        ...
        <section>
          ...
          <div className="mt-6 rounded-[var(--radius-lg)] border border-amber-200 bg-amber-50/50 p-5 dark:border-amber-900/30 dark:bg-amber-950/20">
