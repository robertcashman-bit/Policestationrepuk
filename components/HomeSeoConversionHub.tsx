...
const COVERAGE_LINKS = [
  ...
  { href: '/PoliceStationRepsSurrey', label: 'Surrey' },
  { href: '/PoliceStationRepsSussex', label: 'Sussex' },
  { href: '/PoliceStationRepsHertfordshire', label: 'Hertfordshire' },
  { href: '/PoliceStationRepsHampshire', label: 'Hampshire' },
  { href: '/PoliceStationRepsBerkshire', label: 'Thames Valley (Berks)' },
