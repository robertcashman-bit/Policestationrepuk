...
const PAGE_PATH: Record<string, ContentSource[]> = {
  ...
  '/CommonOffencesGuide': [
    ...
    { label: 'CPS — Theft Act offences', href: 'https://www.cps.gov.uk/legal-guidance/theft-act-offences' },
    { label: 'CPS — Stalking or harassment', href: 'https://www.cps.gov.uk/prosecution-guidance/stalking-or-harassment' },
    {
