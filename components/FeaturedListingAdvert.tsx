      ...
      <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-sm leading-relaxed text-white/85">
            PoliceStationRepUK.org is a live directory for police station representatives, solicitors
            and clients. Representatives can upgrade to a Featured Listing for enhanced visibility
            across the platform.
          </p>
          ...
          <p className="mt-3 text-sm">
            <span className="font-bold text-[var(--gold)]">From £4.99 per month.</span>{' '}
            <span className="text-slate-200">Cancel anytime from your account.</span>
          </p>
        </div>
