...
const SITE_INTENT_ENTRIES: AssistantEntry[] = [
  ...
  },
  {
    ...
    answer:
      'Text the published number or use the audience-specific join pages for reps, solicitors, or firms. Verification is required before you are added. Criminal defence practices can also post in the group asking for police station and court cover — the same verified group as accredited reps.',
    category: 'Community',
    href: '/whatsapp',
