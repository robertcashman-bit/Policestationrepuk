    ...
    <>
      <section className="bg-[var(--navy)] py-12 sm:py-16">
        <div className="page-container !py-0">
          ...
          <p className="mt-4 max-w-2xl text-lg leading-relaxed text-slate-300">A comprehensive guide to the role, responsibilities, and daily work of accredited police station representatives in England and Wales.</p>
        </div>
      </section>
